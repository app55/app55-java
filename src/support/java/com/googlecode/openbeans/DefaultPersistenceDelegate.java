...
public class DefaultPersistenceDelegate extends PersistenceDelegate
{
	...
	/**
	 * Constructs a <code>DefaultPersistenceDelegate</code> instance that supports the persistence of a bean which has a default constructor.
	 * 
	 */
	...
	/**
	 * Returns an expression that represents a call to the bean's constructor. The constructor may take zero or more parameters, as specified when this
	...
	/**
	 * Determines whether one object mutates to the other object. If this <code>DefaultPersistenceDelegate</code> is constructed with one or more property
