...
public class BeanDescriptor extends FeatureDescriptor
{
	...
	/**
	 * <p>
	 * Constructs an instance with the bean's {@link Class} and a customizer {@link Class}. The descriptor's {@link #getName()} is set as the unqualified name
	 * of the <code>beanClass</code>.
	 * </p>
	 * 
	 * @param beanClass
	 *            The bean's Class.
	...
	/**
	 * <p>
	 * Constructs an instance with the bean's {@link Class}. The descriptor's {@link #getName()} is set as the unqualified name of the <code>beanClass</code>.
	 * </p>
	 * 
	 * @param beanClass
	 *            The bean's Class.
