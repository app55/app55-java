...
/**
 * This support class implements <code>BeanContextServices</code> interface. This class can be used directly, or be a super class of your class, or be a
 * delegate of your implementation that needs to support <code>BeanContextServices</code> interface.
 * 
 */
...
public class BeanContextServicesSupport extends BeanContextSupport implements BeanContextServices, Serializable
{
	...
	private static class ServiceRecord
	{
		...
		ServiceRecord(BeanContextServiceProvider provider, BeanContextChild child, Object requestor, Class serviceClass,
				BeanContextServiceRevokedListener revokedListener, Object service, boolean isDelegate)
		{
	...
	/**
	 * Every child of context is companied with a <code>BCSSChild</code> instance. It can hold implementation specific information about each child.
	 * <p>
	...
	/**
	 * This class implements the <code>BeanContextServiceProvider</code> interface by wrapping a <code>BeanContextServices</code>. All services registered in
	 * the <code>BeanContextServices</code> are accessible via this wrapper service provider.
	 * <p>
	 * This class is used by <code>BeanContextServicesSupport</code> to access services provided by its parent context (if there is one).
	 * </p>
	 * 
	 */
	protected class BCSSProxyServiceProvider implements BeanContextServiceProvider, BeanContextServiceRevokedListener
	{
		 ...
		 */
		Object getService(BeanContextServices bcs, Object requestor, Class serviceClass, Object serviceSelector, BeanContextServiceRevokedListener listener)
				throws TooManyListenersException
		{
			return backBCS.getService(BeanContextServicesSupport.this.getBeanContextServicesPeer(), requestor, serviceClass, serviceSelector,
					new ServiceRevokedListenerDelegator(listener));
		}
		...
		{
			backBCS.releaseService(BeanContextServicesSupport.this.getBeanContextServicesPeer(), requestor, service);
		}
	...
	private class ServiceRevokedListenerDelegator implements BeanContextServiceRevokedListener
	{
		...
		{
			backListener.serviceRevoked(new BeanContextServiceRevokedEvent(BeanContextServicesSupport.this.getBeanContextServicesPeer(), event
					.getServiceClass(), event.isCurrentServiceInvalidNow()));
		}

	}

	/**
	 * Every servie registered in this context is companied with a <code>BCSSServiceProvider</code> instance. It can hold implementation specific information
	 * about each registered service.
	 * <p>
	...
	/**
	 * A map of all registered services - key is service class, value is <code>BCSSServiceProvider</code> object. All access to this object should be
	...
	/**
	 * A list of registered <code>BeanContextServicesListener</code>s. All access to this object should be synchronized on itself.
	 */
	 ...
	 * 
	 * @see
	 * com.googlecode.openbeans.beancontext.BeanContextServices#addBeanContextServicesListener(com.googlecode.openbeans.beancontext.BeanContextServicesListener)
	 */
	 ...
	 * </p>
	 * 
	 * @see com.googlecode.openbeans.beancontext.BeanContextServices#addService(java.lang.Class,
	 *      com.googlecode.openbeans.beancontext.BeanContextServiceProvider)
	 */
	 ...
	 * <p>
	 * First a <code>int</code> is read, indicating the number of services to read. Then pairs of service class and service provider are read one by one.
	 * </p>
	 * 
	 * @see com.googlecode.openbeans.beancontext.BeanContextSupport#bcsPreDeserializationHook(java.io.ObjectInputStream)
	 */
	@SuppressWarnings("unchecked")
	 ...
	 * <p>
	 * First a <code>int</code> is writtern, indicating the number of serializable services. Then pairs of service class and service provider are writtern one
	 * by one.
	 * </p>
	 * 
	 * @see com.googlecode.openbeans.beancontext.BeanContextSupport#bcsPreSerializationHook(java.io.ObjectOutputStream)
	 */
	 ...
	 * </p>
	 * 
	 * @see com.googlecode.openbeans.beancontext.BeanContextSupport#childJustRemovedHook(java.lang.Object,
	 *      com.googlecode.openbeans.beancontext.BeanContextSupport.BCSChild)
	 */
	 ...
	 * 
	 * @see com.googlecode.openbeans.beancontext.BeanContextSupport#createBCSChild(java.lang.Object, java.lang.Object)
	 */
	...
	/**
	 * Fires a <code>BeanContextServiceAvailableEvent</code> to registered <code>BeanContextServicesListener</code>s.
	 * 
	 * @param serviceClass
	...
	{
		fireServiceAdded(new BeanContextServiceAvailableEvent(this, serviceClass));
	}
	...
	/**
	 * Fires a <code>BeanContextServiceRevokedEvent</code> to registered <code>BeanContextServicesListener</code>s.
	 * 
	 * @param serviceClass
	...
	{
		fireServiceRevoked(new BeanContextServiceRevokedEvent(this, serviceClass, revokeNow));
	}
	...
	/**
	 * Returns the given child casted to <code>BeanContextServicesListener</code>, or null if it does not implements the interface.
	 * 
	 * @param child
	 *            a child
	 * @return the given child casted to <code>BeanContextServicesListener</code>, or null if it does not implements the interface
	 */
	...
	/**
	 * Returns an iterator of all registered service classes, with <code>removed()</code> disabled.
	 * 
	 * @return an iterator of all registered service classes
	 * @see com.googlecode.openbeans.beancontext.BeanContextServices#getCurrentServiceClasses()
	 */
	...
	/**
	 * Returns the service selectors of the specified service. The iterator's <code>remove()</code> operation is disabled.
	 * 
	...
	public Iterator getCurrentServiceSelectors(Class serviceClass)
	{
		...
		return provider == null ? null : new BCSIterator(provider.getCurrentServiceSelectors(getBeanContextServicesPeer(), serviceClass));
	}
	 ...
	 * @throws TooManyListenersException
	 * @see com.googlecode.openbeans.beancontext.BeanContextServices#getService(com.googlecode.openbeans.beancontext.BeanContextChild, java.lang.Object,
	 *      java.lang.Class, java.lang.Object, com.googlecode.openbeans.beancontext.BeanContextServiceRevokedListener)
	 */
	...
	public boolean hasService(Class serviceClass)
	{
		...
		{
			has = ((BeanContextServices) getBeanContext()).hasService(serviceClass);
		}
		return has;
	}
	...
	/**
	 * Called after the parent context is updated. The implementation checks if the parent context is a <code>BeanContextServices</code>. If it is, then a
	 * <code>BCSSProxyServiceProvider</code> is created to delegate service requests to the parent context.
	 * 
	 ...
	 * 
	 * @see com.googlecode.openbeans.beancontext.BeanContextChildSupport#releaseBeanContextResources()
	 */
	 ...
	 * 
	 * @see
	 * com.googlecode.openbeans.beancontext.BeanContextServices#removeBeanContextServicesListener(com.googlecode.openbeans.beancontext.BeanContextServicesListener
	 * )
	 */
			...
			BCSSChild bcssChild)
	{
		...
		synchronized (bcssChild.child)
		{
			for (Iterator it = bcssChild.serviceRecords.iterator(); it.hasNext();)
			{
				...
				{
					rec.revokedListener
							.serviceRevoked(new BeanContextServiceRevokedEvent(getBeanContextServicesPeer(), serviceClass, revokeCurrentServicesNow));
	...
	/**
	 * Notify all listeners and children that implements <code>BeanContextServices</code> of the event.
	 * 
