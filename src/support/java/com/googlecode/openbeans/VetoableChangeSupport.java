...
public class VetoableChangeSupport implements Serializable
{
	...
	public synchronized VetoableChangeListener[] getVetoableChangeListeners(String propertyName)
	{
		...
		return (listeners == null) ? new VetoableChangeListener[] {} : getAsVetoableChangeListenerArray(listeners);
	}
	...
	public synchronized void addVetoableChangeListener(VetoableChangeListener listener)
	{
		if (listener != null)
		{
			if (listener instanceof VetoableChangeListenerProxy)
			{
				...
				addVetoableChangeListener(proxy.getPropertyName(), (VetoableChangeListener) proxy.getListener());
			}
			else
			{
