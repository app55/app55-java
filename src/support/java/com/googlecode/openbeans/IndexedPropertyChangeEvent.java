...
public class IndexedPropertyChangeEvent extends PropertyChangeEvent
{
	 ...
	 *            the changed bean.
	 * @param propertyName
	 *            the changed property, or <code>null</code> to indicate an unspecified set of the properties have changed.
	 * @param oldValue
	 *            the previous value of the property, or <code>null</code> if the <code>propertyName</code> is <code>null</code> or the previous value is
	 *            unknown.
	 * @param newValue
	 *            the new value of the property, or <code>null</code> if the <code>propertyName</code> is <code>null</code> or the new value is unknown..
	 * @param index
