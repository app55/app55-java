...
/**
 * <code>XMLEncoder</code> extends <code>Encoder</code> to write out the encoded statements and expressions in XML format. The XML can be read by
...
public class XMLEncoder extends Encoder
{
	...
	/**
	 * Call <code>flush()</code> first, then write out XML footer and close the underlying output stream.
	 */
	public void close()
	{
		flush();
