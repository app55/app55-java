...
public class IndexedPropertyDescriptor extends PropertyDescriptor
{
	 ...
	 */
	public IndexedPropertyDescriptor(String propertyName, Class<?> beanClass, String getterName, String setterName, String indexedGetterName,
	...
	/**
	 * Determines if this <code>IndexedPropertyDescriptor</code> is equal to the specified object. Two <code>IndexedPropertyDescriptor</code> s are equal if the
