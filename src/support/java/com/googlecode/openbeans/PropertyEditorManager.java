...
public class PropertyEditorManager
{
	...
	private static PropertyEditor loadEditor(Class<?> targetType, String className) throws ClassNotFoundException, IllegalAccessException,
	...
	public static synchronized PropertyEditor findEditor(Class<?> targetType)
	{
		...
		String shortEditorClassName = (targetType.isPrimitive() ? (editorClassName.substring(0, 1).toUpperCase() + editorClassName.substring(1))
				: editorClassName.substring(editorClassName.lastIndexOf('.') + 1));
