...
public class PropertyChangeSupport implements Serializable
{
	...
	public void fireIndexedPropertyChange(String propertyName, int index, Object oldValue, Object newValue)
	{
		...
		doFirePropertyChange(new IndexedPropertyChangeEvent(source, propertyName, oldValue, newValue, index));
	}
	...
	public synchronized PropertyChangeListener[] getPropertyChangeListeners(String propertyName)
	{
		...
		return (listeners == null) ? new PropertyChangeListener[0] : listeners.getPropertyChangeListeners();
	}
	...
	{
		ArrayList<PropertyChangeListener> result = new ArrayList<PropertyChangeListener>(globalListeners);
		for (String propertyName : children.keySet())
		{
			PropertyChangeSupport namedListener = children.get(propertyName);
	...
	private void writeObject(ObjectOutputStream oos) throws IOException
	{
		...
		PropertyChangeListener[] gListeners = globalListeners.toArray(new PropertyChangeListener[0]);
