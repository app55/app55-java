...
public class BeansUtils
{
	...
	{
		return (base == boolean.class) && (wrapper == Boolean.class) || (base == byte.class) && (wrapper == Byte.class) || (base == char.class)
				&& (wrapper == Character.class) || (base == short.class) && (wrapper == Short.class) || (base == int.class) && (wrapper == Integer.class)
				|| (base == long.class) && (wrapper == Long.class) || (base == float.class) && (wrapper == Float.class) || (base == double.class)
	...
	public static boolean declaredEquals(Class<?> clazz)
	{
		...
		{
			if (EQUALS_METHOD.equals(declaredMethod.getName()) && Arrays.equals(declaredMethod.getParameterTypes(), EQUALS_PARAMETERS))
			{
				return true;
			}
		}
